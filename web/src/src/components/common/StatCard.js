...
//             {iconMap[icon] || iconMap['document-text']}
//           </div>
  ...
  return (
    <div
      className={`bg-white overflow-hidden shadow rounded-lg ${
        clickable ? 'cursor-pointer transform hover:scale-105 transition-transform duration-200' : ''
      }`}
        ...
        <div className="flex items-center">
          <div className="flex-shrink-0">
            <div className={`w-8 h-8 rounded-md ${colorClasses[color]} flex items-center justify-center`}>
              <svg className={`w-5 h-5 ${iconClasses[color]}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                {getIcon(icon)}
              </svg>
            </div>
          </div>
